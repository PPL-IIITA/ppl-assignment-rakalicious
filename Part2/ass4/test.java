...
public class test {
    ...
    /**
     * comparator for sorting gift based on price
     */
    ...
    /**
     * comparator for sorting couple based happiness
     */
    ...
    /**
     * comparator for sorting couple based on compatibility
     */
    ...
    public void go(){
        ...
        try{
            PrintWriter writer = new PrintWriter("BreakUpGiftsExchanged.txt");
        ...
        //assigning gifts
        methodsAfterCouples(coupleArray,giftArray,0);
        ...
        methodsAfterCouples(coupleArray,giftArray,1);
        
        //sorting couples by happiness
        Collections.sort(coupleArray,new happinessComparator());
        try{
           
            PrintWriter writer = new PrintWriter("AfterBreakupHappinessSortedCouples.txt");
            for(Couple c :coupleArray){
                writer.println(c.get_boy().get_name() + " and " + c.get_girl().get_name());
                writer.println("Happiness " + c.get_couple_happiness());
            }
     ...
     */
    public void methodsAfterCouples(ArrayList <Couple> coupleArray,ArrayList <Gifts> giftArray,int time){
        for(Couple c : coupleArray){
            c.choose_gift(giftArray,time);
